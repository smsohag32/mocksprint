      ...
      <nav className="sticky top-0 z-50 glass">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold gradient-text">MockSprint</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            {isAuthenticated ? (
              <Link to="/dashboard">
                <Button className="gradient-primary text-primary-foreground">Dashboard</Button>
              </Link>
            ) : (
              <>
                <Link to="/login">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground animate-slide-up">
            ...
            pressure mode, and instant feedback. Climb the leaderboard and land your dream job.
          </p>
          <div className="mt-10 flex items-center justify-center gap-4 animate-slide-up">
            <Link to={isAuthenticated ? '/interview' : '/register'}>
              <Button size="lg" className="gradient-primary text-primary-foreground gap-2 animate-pulse-glow">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="mx-auto max-w-2xl rounded-2xl gradient-primary p-12">
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">Ready to level up?</h2>
