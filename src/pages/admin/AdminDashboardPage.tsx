...
export default function AdminDashboardPage() {
  ...
  const stats = [
    ...
    { label: 'Questions', value: questions?.length || 0, icon: FileQuestion, color: 'text-success' },
    { label: 'Leaderboard Entries', value: leaderboard?.length || 0, icon: Trophy, color: 'text-warning' },
