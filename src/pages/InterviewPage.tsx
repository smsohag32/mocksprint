...
import { useStartInterviewMutation, useSubmitInterviewMutation } from '@/services/api/interviewApi';
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <Switch id="pressure" checked={pressureMode} onCheckedChange={setPressureMode} />
              <Label htmlFor="pressure" className="flex items-center gap-1 text-sm">
                <Zap className="h-4 w-4 text-warning" /> Pressure Mode
              </Label>
            </div>
            <Badge variant={isRunning ? 'default' : 'secondary'} className="text-lg px-3 py-1 font-mono">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <Card className="lg:col-span-1 border-border/50">
            ...
            <CardContent className="space-y-4">
              <Select onValueChange={(v) => {
                ...
                <SelectContent>
                  {isLoading ? (
                    ...
                    <div className="p-2 text-sm text-muted-foreground">No questions available</div>
                  )}
                </SelectContent>
              </Select>
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    <Badge variant={
                      ...
                      selectedQuestion.difficulty === 'medium' ? 'secondary' : 'destructive'
                    }>
              ...
              <div className="flex gap-2">
                {!isRunning ? (
                  <Button onClick={handleStart} className="flex-1 gradient-primary text-primary-foreground gap-2">
                  ...
                  <>
                    ...
                    <Button onClick={handleSubmit} className="flex-1 gradient-primary text-primary-foreground gap-2">
